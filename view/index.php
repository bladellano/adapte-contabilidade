            ...
            <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 text-center">
                  ...
                  <p class="text-left">Estamos com os nossos contadores experts prontos para falar com você. Entrando em contato, você vai:</p>
                  <ul class="text-left">
                    <li>Receber nosso contato em até 30 minutos.</li>
                    <li>Conhecer todos motivos pelos quais você deve contratar a Agilize.</li>
                    <li>Entender tudo o que precisa ser feito em relação às necessidades contábeis da sua empresa, e saber os valores relacionados a isso.</li>
                    <li>Saber o quanto você vai economizar fazendo sua contabilidade conosco (garantimos, em média, R$ 5 mil reais por ano).</li>
                  </ul>
                  <p class="text-left">Fique tranquilo(a) que o nosso contato é sem compromisso. Você só vai contratar a Agilize quando tiver certeza de que somos a melhor opção para a sua empresa.</p>
                </div>
                <div class="col-md-6 text-center">
                  ...
                  <form id="form-contato-adapte">
                    ...
                    <div class="form-group">
                      ...
                      <select name="area_atuacao" id="area_atuacao" class="form-control" required>
                        ...
                        <option value="Desenvolvimento de software ou sites">Desenvolvimento de software ou sites</option>
                        ...
                        <option value="Organização e Promoção de Eventos">Organização e Promoção de Eventos</option>
                        <option value="Publicidade e Propaganda">Publicidade e Propaganda</option>
                        <option value="Prestador de serviços em geral">Prestador de serviços em geral</option>
                        <option value="Recursos humanos">Recursos humanos</option>
                        <option value="Representação comercial">Representação comercial</option>
                        <option value="Restaurantes">Restaurantes</option>
                        <option value="Salas de acesso a internet">Salas de acesso a internet</option>
                        <option value="Serviços administrativos">Serviços administrativos</option>
                        <option value="Serviços de lavagem automotiva">Serviços de lavagem automotiva</option>
                        <option value="Serviços de TI">Serviços de TI</option>
                        <option value="Serviços online (SaaS)">Serviços online (SaaS)</option>
                        <option value="Terceirização de mão de obra">Terceirização de mão de obra</option>
                        <option value="Tradução">Tradução</option>
                        <option value="Treinamentos">Treinamentos</option>
                        <option value="Turismo">Turismo</option>
                        <!-- Deve ser o ultimo item da lista -->
                        <option value="Meu serviço não está na lista">Meu serviço não está na lista</option>
                      </select>
                    </div>

                    <div class="form-group">
                      <label for="email">Qual seu e-mail profissional?</label>
                      <input type="email" name="email" class="form-control" id="email" placeholder="Digite seu e-mail completo">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="tel" name="telefone" class="form-control" id="telefone" placeholder="(00) 00000-0000">
                    </div>
                    <button type="submit" name="btn_proposta" id="btn_proposta" class="btn btn-danger btn-lg">RECEBER O NOSSO CONTATO <i class="fas fa-paper-plane"></i></button>
            ...
            <div class="container">
              ...
              <div class="slick-depoimentos">
                <div>
                  ...
                  <p>Amélia Borralho</p>
                  "Contra fatos não há argumentos. A competência deste grupo se revela a cada dia. Parabéns @adaptcontabilidade."
                </div>
                <div>
                  <img src="assets/img/nayara.jpg" alt="">
                  <p>Naiara Afonso</p>
                  "Parabéns a Adapt Contabilidade por serviços maravilhosos e esclarecedoros. Amei! desejo todo sucesso do munto!"
                </div>
              </div>
            </div>
          </div>
